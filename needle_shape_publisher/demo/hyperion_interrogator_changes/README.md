...
6. Convert those mm-based curvatures to the calibration pipeline's processed
   rad/m units before inverting the calibration matrices.
7. Interpolate at each active-area (AA) sensor location.
